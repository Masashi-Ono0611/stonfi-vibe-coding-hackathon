      ...
      <main className="flex-1 flex flex-col gap-4 max-w-lg mx-auto w-full px-4 py-6">
        ...
        {!hasActiveWallet && (
          <div className="flex flex-col gap-2">
            ...
            <button
              onClick={login}
              className="w-full bg-[#fe8370] hover:bg-[#e86d5a] rounded-xl p-4 text-left transition-colors"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center text-[#fe8370] text-xs font-bold flex-shrink-0">P</div>
                  <div>
          ...
          <div className="bg-white rounded-xl border border-[#e8e8e8] p-3 flex gap-2">
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-xs font-medium transition-colors ${
                activeWallet === 'privy' ? 'bg-[#fe8370] text-white' : 'bg-[#e8e8e8] text-[#202020] hover:bg-[#d4d4d4]'
              }`}
            >
              Swap with Privy
            </button>
